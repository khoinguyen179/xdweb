...
<?php $__env->startSection('content'); ?>
    <form class="container-fluid" action="<?php echo e(route('products.update',$product->id)); ?>" method="POST"
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <img id="image_avatar" src="<?php echo e($product->image); ?>"/>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\OneDrive\Desktop\web (2)\resources\views/admin/products/edit-product.blade.php ENDPATH**/ ?>