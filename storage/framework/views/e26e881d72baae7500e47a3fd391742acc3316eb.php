                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <form class="float-right" action="<?php echo e(route('products.destroy', $product->id)); ?>"
                                                  method="POST" onSubmit="if(!confirm('<?php echo e(trans('site.products.confirm')); ?>'))
												  {return false;}">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\OneDrive\Desktop\web (1)\resources\views/admin/products/index.blade.php ENDPATH**/ ?>